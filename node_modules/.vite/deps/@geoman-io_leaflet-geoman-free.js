...
(() => {
  ...
  var rh = (t, e, i, r) => {
    if (e && typeof e == "object" || typeof e == "function") for (let n of th(e)) !ih.call(t, n) && n !== i && lr(t, n, { get: () => e[n], enumerable: !(r = Ql(e, n)) || r.enumerable });
    return t;
  };
  ...
  function ie(t, e) {
    fm(t, function(i, r, n, s, a) {
      ...
      for (var u = 0; u < i.coordinates.length; u++) {
        var f = i.coordinates[u], d = { type: l, coordinates: f };
        if (e(Dt(d, n), r, u) === false) return false;
      }
    });
  }
  function dm(t) {
  ...
  var _l = Xm;
  function Ke(t, e, i) {
    if (i === void 0 && (i = {}), i.final === true) return Jm(t, e);
  ...
  function ne(t, e, i) {
    ...
    if (a && Wm(r, a) === false) return false;
    s === "Polygon" && (o = [o]);
  ...
  function Qm(t, e, i) {
    ...
    for (var r = rt(t), n = ot(e), s = 0; s < n.length - 1; s++) {
      var a = false;
      if (i.ignoreEndVertices && (s === 0 && (a = "start"), s === n.length - 2 && (a = "end"), s === 0 && s + 1 === n.length - 1 && (a = "both")), t_(n[s], n[s + 1], r, a, typeof i.epsilon > "u" ? null : i.epsilon)) return true;
    }
    return false;
  }
  ...
  function e_(t, e) {
    var i, r = false;
    for (i = 0; i < t.coordinates.length; i++) if (Ji(t.coordinates[i], e.coordinates)) {
      r = true;
      break;
    }
    return r;
  ...
  function Cl(t) {
    ...
    b.clone = Cl, b.ROUND_UP = 0, b.ROUND_DOWN = 1, b.ROUND_CEIL = 2, b.ROUND_FLOOR = 3, b.ROUND_HALF_UP = 4, b.ROUND_HALF_DOWN = 5, b.ROUND_HALF_EVEN = 6, b.ROUND_HALF_CEIL = 7, b.ROUND_HALF_FLOOR = 8, b.EUCLID = 9, b.config = b.set = function(h) {
      ...
      return function(p) {
        ...
        if (p == null ? p = a : J(p, 0, tt), C = $i(p / F), P) if (crypto.getRandomValues) {
        ...
        if (Z[M] > (st[M] || 0) && w--, ct < 0) W.push(1), B = true;
          ...
          do {
            if (I = 0, v = c(Z, U, bt, K), v < 0) {
              if (it = U[0], bt != K && (it = it * m + (U[1] || 0)), I = dt(it / ai), I > 1) for (I >= m && (I = m - 1), N = h(Z, I, m), j = N.length, K = U.length; c(N, U, j, K) == 1; ) I--, p(N, bt < j ? le : Z, j, m), j = N.length, v = 1;
              else I == 0 && (v = I = 1), N = Z.slice(), j = N.length;
              if (j < K && (N = [0].concat(N)), p(U, N, K, m), K = U.length, v == -1) for (; c(Z, U, bt, K) < 1; ) I++, p(U, bt < K ? le : Z, K, m), K = U.length;
            } else v === 0 && (I++, U = [0]);
    ...
    function A(h, c, p, y) {
      ...
      if (B) {
        t: {
          ...
          else if (w = $i((k + 1) / F), w >= B.length) if (y) {
    ...
    _composePolys(e) {
      ...
      for (let r = 0, n = e.length; r < n; r++) {
        ...
        if (!s.poly) if (s.isExteriorRing()) i.push(new ei(s));
          ...
          (a == null ? void 0 : a.poly) || i.push(new ei(a)), (_a3 = a == null ? void 0 : a.poly) == null ? void 0 : _a3.addInterior(s);
        }
      }
      return i;
    }
