    ...
    <form method="post" action="{{ route('profile.update-communication') }}" class="mt-6 space-y-6 max-w-xl">
        ...
        <div>
            ...
            <div class="w-full items-center p-1 border border-gray-300 rounded-lg mt-1 space-y-1">
                <x-form.label for="contact_phone_visible" class="items-center grid grid-cols-2 gap-2 w-full justify-between hover:bg-gray-50 p-3 rounded-lg">
                ...
                <x-form.label for="telegram_visible" class="items-center grid grid-cols-2 gap-2 w-full justify-between hover:bg-gray-50 p-3 rounded-lg">
                    <div class="flex space-x-1">
                    ...
                    <x-form.checkbox 
                        ...
                        class="peer/telegram ml-auto" 
                        value="1" 
                        :checked="old('communication.telegram.visible', $user->communication?->telegram?->visible ?? false)"
                    />
    
                    <div class="hidden peer-checked/telegram:block col-span-2 space-y-2">
                        <x-form.label 
                            for="telegram_phone" 
                ...
                <x-form.label for="whatsapp_visible" class="items-center grid grid-cols-2 gap-2 w-full justify-between hover:bg-gray-50 p-3 rounded-lg">
                    <div class="flex space-x-1">
                    ...
                    <x-form.checkbox 
                        ...
                        class="peer/whatsapp ml-auto" 
                        value="1" 
                        :checked="old('communication.whatsapp.visible', $user->communication?->whatsapp?->visible ?? false)"
                    />
    
                    <div class="hidden peer-checked/whatsapp:block col-span-2 space-y-2">
                        <x-form.label 
                            for="phone"
