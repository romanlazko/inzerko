        ...
        <div class="sm:flex grid sm:grid-cols-2 grid-cols-1 sm:space-x-2 justify-between sm:space-y-0 space-y-6">
            <div class="flex-col max-w-xl w-full sm:w-1/2 ">
                <x-telegram::white-block>
                    ...
                    <form method="post" action="{{ route('pozor_baraholka_bot.category.store') }}" class="space-y-6 ">
                        @csrf
                        @method('post')
                        ...
                        <div>
                            ...
                            <x-telegram::form.input id="icon_name" name="icon_name" type="text" class="mt-1 block w-full" :value="old('icon_name')" required autofocus autocomplete="icon_name" />
