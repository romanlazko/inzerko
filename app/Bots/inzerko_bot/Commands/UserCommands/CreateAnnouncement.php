...
class CreateAnnouncement extends Command
{
    ...
    public function execute(Update $updates): Response
    {
        ...
        $url = env('APP_URL').URL::signedRoute('inzerko_bot:announcement.create', ['email' => $user->email, 'telegram_chat_id' => $telegram_chat->id, 'route' => 'inzerko_bot.announcements.create'], null, false);
